  ...
  mounted(){
    ...
    methods:{
       ...
       modify:function(){
            ...
            this.$http.post('http://localhost:8080/boardUpdate',{userid:this.$store.state.userid, title :this.userDetail.TITLE, content :this.userDetail.CONTENT, due_date : this.userDetail.DUE_DATE},{ //해당 userdetial.empno를 가져온다!!
            method : 'POST',
