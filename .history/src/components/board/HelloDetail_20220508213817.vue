<template>
    ...
    <div style ="margin:30px">
         ...
         <div class="mb-3" align="left">
            ...
            <v-text-field type="text" id="exampleFormControlInput1"></v-text-field>
  ...
  mounted(){
    ...
    methods:{
       ...
       modify:function(){
            ...
            this.$http.post('http://localhost:8080/testupdate',{ title :this.userDetail.TITLE, content :this.userDetail.CONTENT},{ //해당 userdetial.empno를 가져온다!!
            method : 'POST',
