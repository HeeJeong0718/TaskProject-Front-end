...
<v-container>
  <v-app>
      ...
      <v-select outlined :items="department" :hint="`${department.DEP_ID},${leader.DEP_NM}`"
      item-text="id" item-value="id" persistent-hint return-object>
    ...
    insertform :function(){
       ...
       this.$http.post('http://localhost:8080/departlist',{},{
        ...
        this. department2 = JSON.stringify(response.data.list[0]);
         ...
         console.log("rs" + JSON.stringify(response.data.list.DEP_NM));
