       ...
       <div style ="margin:30px">
        <div align="right">
         ...
         <div class="mb-3" align="left">
            ...
            <input type="text" class="form-control" id="exampleFormControlInput1" v-model="modifyDetail.ENAME" >
        </div>
         <div class="mb-3" align="left">
            <label for="exampleFormControlInput1" class="form-label">CONTENT</label>
            <textarea name="content" id="content" cols="30" rows="10" v-model="modifyDetail.CONTENT" >></textarea>
        </div>
...
export default {
 ...
 methods:{
     toBack(){
      ...
      Confirm :function(){
       this.$http.post('/testupdate',{ename:this.ename , content : this.content, empno : this.empno}, { //파라미터릂 여기에 줘야함 ->스프링 컨트롤러에 있는 vo랑똑같은이름써저야한다!!!
            method : 'POST',
            body : JSON.stringify({
