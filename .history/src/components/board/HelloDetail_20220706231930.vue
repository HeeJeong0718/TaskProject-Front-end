    ...
    <div style ="margin:30px">
       ...
       <div class="mb-2" align="left">
            ...
            <v-menu
              ...
              :return-value.sync="this.userDetail.DUE_DATE"
            ...
            >
              <template v-slot:activator="{ on, attrs }">
                <v-text-field
                  v-model="this.userDetail.DUE_DATE"
  ...
  mounted(){
    ...
    methods:{
       ...
       modify:function(){
            ...
            this.$http.post('http://localhost:8080/boardUpdate',{mem_id:this.$store.state.mem_id, b_title :this.userDetail.B_TITLE, b_content :this.userDetail.B_CONTENT, due_date : this.userDetail.DUE_DATE},{ //해당 userdetial.empno를 가져온다!!
            method : 'POST',
