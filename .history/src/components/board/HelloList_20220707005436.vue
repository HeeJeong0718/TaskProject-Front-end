<template>
   <v-container>
    <div id="board" v-if="$store.state.mem_id">
        <v-date-picker               @input="datePickerStartDate = false"               v-model="newUnitPage1.start_date_of_unit" type="date"               :show-current="false"               :max="newUnitPage1.end_date_of_unit"></v-date-picker>
