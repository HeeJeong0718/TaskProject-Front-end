...
export default {
  ...
  created(){
   ...
   modify:function(){
            this.$http.post('http://localhost:8080/MypageUpdate',{userid:this.$store.state.userid , username :this.myinfo.USERNAME, userpass:this.myinfo.USERPASS, department_id :this.myinfo.DEPARTMENT_ID, department_nm : this.myinfo.DEPARTMENT_NM},{ //해당 userdetial.empno를 가져온다!!
            method : 'POST',
