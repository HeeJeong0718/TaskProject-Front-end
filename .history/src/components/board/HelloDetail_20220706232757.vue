  ...
  mounted(){
    ...
    methods:{
       ...
       modify:function(){
            ...
            this.$http.post('http://localhost:8080/boardUpdate',{b_id:this.$store.state.mem_id, b_title :this.userDetail.B_TITLE, b_content :this.userDetail.B_CONTENT, due_date : this.userDetail.DUE_DATE},{ //해당 userdetial.empno를 가져온다!!
            method : 'POST',
