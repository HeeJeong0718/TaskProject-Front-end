<template>
   <v-container>
    <div id="board" v-if="$store.state.mem_id">
        <el-date-picker v-model="startDate" type="date" placeholder="시작일" value-format="yyyyMMdd" @change="changeDate('start')" :picker-options="startDateOptions" ></el-date-picker>
