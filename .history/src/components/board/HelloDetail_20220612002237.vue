       ...
       <div class="mb-2" align="left">
         ...
         <div class="mb-2" align="left">
          ...
          >
            ...
            <v-date-picker v-model="userDetail.DUE_DATE" no-title scrollable >
              <v-spacer></v-spacer>
  ...
  mounted(){
    ...
    methods:{
       ...
       modify:function(){
            ...
            this.$http.post('http://localhost:8080/boardUpdate',{ title :this.userDetail.TITLE, content :this.userDetail.CONTENT, due_date : this.DUE_DATE},{ //해당 userdetial.empno를 가져온다!!
            method : 'POST',
