...
<v-container>
  <v-app>
      ...
      <v-select outlined :items="department.filter(item=>item.DEP_ID)" v-model="department.DEP_ID" :hint="`${department.DEP_ID}`"
      item-text="department.DEP_ID" item-value="value" persistent-hint 
      return-object>
