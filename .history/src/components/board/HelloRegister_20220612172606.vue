...
export default {
   ...
   methods:{
    insertform :function(){
       this.$http.post('http://localhost:8081/testregister',{userid :this.userid , userpass : this.userpass , username : this.username ,department_nm : this.department_nm, department_id : this.department_id },{
            method : 'POST',
