<template>
       <div style ="margin:30px">
        <div align="right">
            <button type="button" class="btn btn-outline-info btn-sm" v-if="editMode!=editMode" @click='Confirm()'>수정</button>
             <button type="button" class="btn btn-outline-info btn-sm" v-if="editMode == editMode"  @click='write()'>입력</button>
