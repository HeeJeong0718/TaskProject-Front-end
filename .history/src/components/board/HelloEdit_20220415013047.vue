<template>
       <div style ="margin:30px">
        <div align="right">
            <button type="button" class="btn btn-outline-info btn-sm"  @click='Confirm()'>Confirm</button>
             <button type="button" class="btn btn-outline-info btn-sm"  @click='write()'>write</button>
         ...
         <div class="mb-3" align="left">
            ...
            <input type="text" class="form-control" v-if="modifyDetail.EMPNO"  id="exampleFormControlInput1" v-model="modifyDetail.EMPNO" >
              <input type="text" class="form-control" v-if="!modifyDetail.EMPNO"  id="exampleFormControlInput1">
        </div>
         <div class="mb-3" align="left">
            ...
            <input type="text" class="form-control" v-if="modifyDetail.ENAME" id="exampleFormControlInput1" v-model="modifyDetail.ENAME" >
              <input type="text" class="form-control" v-if="!modifyDetail.ENAME" id="exampleFormControlInput1">
        </div>
         <div class="mb-3" align="left">
            ...
            <textarea name="content" id="content"  v-if="modifyDetail.CONTENT" cols="30" rows="10" v-model="modifyDetail.CONTENT" ></textarea>
              <textarea name="content" id="content"  v-if="!modifyDetail.CONTENT" cols="30" rows="10" ></textarea>
        </div>
