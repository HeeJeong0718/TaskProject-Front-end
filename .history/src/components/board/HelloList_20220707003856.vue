<template>
   <v-container>
    <div id="board" v-if="$store.state.mem_id">
         <v-text-field v-model="start_date" append-icon="mdi-magnify" label="start_date" single-line hide-details></v-text-field>
          <v-text-field v-model="end_date" append-icon="mdi-magnify" label="end_date" single-line hide-details></v-text-field>
      <div>
